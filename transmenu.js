...
TransMenu.dingbatOn = "img/x.gif";            // path to the active sub menu dingbat
TransMenu.dingbatOff = "img/x.gif";          // path to the inactive sub menu dingbat
...
TransMenu.shadowSize = 5;                              // size of shadow under menu
TransMenu.shadowOffset = 3;                            // distance shadow should be offset from leading edge
TransMenu.shadowColor = "#888";                        // color of shadow (transparency is set in CSS)
TransMenu.shadowPng = "img/grey-40.png";               // a PNG graphic to serve as the shadow for mac IE5
TransMenu.backgroundColor = "#DBF8BC";                   // color of the background (transparency set in CSS)
